<template>
    <div class="background-overlay">
      <div
        class="absolute top-0 left-40 transform translate-x-64 translate-y-4 h-14 w-14 rounded-full bg-gray-900 dark:bg-white"
      ></div>
      <div
      ...
      ></div>
      <div class="absolute bottom-0 right-30 triangle-shape"></div>
    </div>
</template>
